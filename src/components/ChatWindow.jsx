...
const ChatWindow = forwardRef(function ChatWindow({ onMenuClick, onCharacterPaneClick, chatReloadKey, chatInputRef }, ref) {
  ...
  return (
    <div className="chat-window flex flex-col h-full flex-1 overflow-hidden bg-chatwindow-light dark:bg-chatwindow-dark font-sans border-2 border-primary rounded-2xl shadow-purple-glow">
      {/* Mobile Header */}
      {isMobile && (
