...
const translations = {
  en: {
    ...
    explore: {
      ...
      description: 'Discover and chat with public characters',
      search: 'Search characters...',
      noResults: 'No characters found matching your search',
      filter: 'Filter',
      sort: 'Sort',
    ...
    errors: {
      ...
      serviceUnavailableError: "The service is unavailable. Please try again later.",
      ...
      proxyAuthenticationRequiredError: "Proxy authentication required.",
      requestTimeoutError: "Request timeout.",
      lengthRequiredError: "Length required.",
      ...
      expectationFailedError: "Expectation failed.",
      imATeapotError: "I'm a teapot.",
      misdirectedRequestError: "Misdirected request.",
      ...
      requestHeaderFieldsTooLargeError: "Request header fields too large.",
      unavailableForLegalReasonsError: "Unavailable for legal reasons.",
      ...
      variantAlsoNegotiatesError: "Variant also negotiates.",
      insufficientStorageError: "Insufficient storage.",
  ...
  es: {
    ...
    admin: {
      ...
      ADMIN: 'Administrador',
      searchUsers: 'Buscar usuarios...',
      pendingCharacters: 'Personajes pendientes',
      approvedCharacters: 'Personajes aprobados',
      rejectedCharacters: 'Personajes rechazados',
      reviewCharacter: 'Revisar personaje',
      approve: 'Aprobar',
      reject: 'Rechazar',
      reason: 'Razón',
    ...
    explore: {
      ...
      description: 'Descubre y habla con personajes públicos',
      search: 'Buscar personajes...',
      noResults: 'No se encontraron personajes que coincidan con tu búsqueda',
      filter: 'Filtrar',
      sort: 'Ordenar',
