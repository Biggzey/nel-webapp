...
const translations = {
  en: {
    ...
    errors: {
      ...
      maintenanceError: 'The system is currently under maintenance. Please try again later.',
    ...
    notifications: {
      ...
      characterSubmitted: {
        ...
        message: 'Your character has been submitted for public review. Any changes made to your private copy will not affect the submitted version. You will be notified when it is approved or rejected.'
      },
      characterApproved: {
        title: 'Character Approved',
        message: 'Your character has been approved and is now public!'
      },
      characterRejected: {
